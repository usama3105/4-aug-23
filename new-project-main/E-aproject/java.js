...
info.forEach((val) => {
    ...
    details.innerHTML += `<div class="card mx-2 mt-5 product-card  " style="width: 18rem;height:90vh;border:greenyellow solid 2px;" data-aos="zoom-out-down">
